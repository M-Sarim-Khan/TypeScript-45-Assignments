...
// SOLUTION:
 function storeCarInformation(manufacturer:string, modelName:string, ...extraOption:{[key:string]: any}[]) : Object {
 ...
 let result = storeCarInformation("Toyota", "Yaris", {color : "white"}, {features: ["Air bags", "Hybrid"]})
