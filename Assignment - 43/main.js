...
// SOLUTION:
var MagicianName = ["Harry Potter", "Criss Angel", "David Blaine", "Harry Houdini", "Merlin"];
function copyArray(arr) {
    return __spreadArray([], arr, true);
}
function make_great(MagicianNameArray) {
    for (var i = 0; i < MagicianNameArray.length; i++) {
...
var copyMagicianArray = copyArray(MagicianName);
