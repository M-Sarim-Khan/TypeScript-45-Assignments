...
var friendList1 = guestList.pop();
console.log("\"SORRY\" Mr.".concat(friendList1, " you are not invited on iftar"));
var friendList2 = guestList.pop();
console.log("\"SORRY\" Mr.".concat(friendList2, " you are not invited on iftar"));
var friendList3 = guestList.pop();
console.log("\"SORRY\" Mr.".concat(friendList3, " you are not invited on iftar"));
var friendList4 = guestList.pop();
console.log("\"SORRY\" Mr.".concat(friendList4, " you are not invited on iftar"));
guestList.forEach(function (dinner) {
    console.log("\"".concat(dinner, "\" you are still invited"));
});
guestList.pop();
guestList.pop();
